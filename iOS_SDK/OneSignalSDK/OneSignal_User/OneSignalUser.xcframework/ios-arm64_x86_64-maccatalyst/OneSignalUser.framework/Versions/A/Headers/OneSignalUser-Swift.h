...
- (BOOL)enable:(BOOL)enable SWIFT_WARN_UNUSED_RESULT;
...
- (void)testCreatePushSubscriptionWithSubscriptionId:(NSString * _Nonnull)subscriptionId token:(NSString * _Nonnull)token enabled:(BOOL)enabled;
@end
...
@property (nonatomic, readonly, copy) NSString * _Nullable subscriptionId;
@property (nonatomic, readonly, copy) NSString * _Nullable token;
/// Get the <code>enabled</code> state.
@property (nonatomic, readonly) BOOL enabled;
/// Set the <code>enabled</code> state. After being set, we return whether this was successful, as one can attempt to set <code>enabled</code> to <code>true</code> but push is not actually enabled on the device. This can be due to system level permissions or missing push token, etc.
///
/// returns:
/// A boolean indicating if this method was successful.
- (BOOL)enable:(BOOL)enable SWIFT_WARN_UNUSED_RESULT;
@end
