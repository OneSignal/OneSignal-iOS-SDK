...
@objc public class OSConsistencyManager: NSObject {
    ...
    private var conditions: [String: [(OSCondition, DispatchSemaphore)]] = [:] // Track conditions by id
    ...
    @objc public func registerCondition(_ condition: OSCondition, forId id: String) -> String? {
