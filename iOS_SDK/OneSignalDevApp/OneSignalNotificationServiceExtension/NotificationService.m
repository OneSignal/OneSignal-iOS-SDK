...
- (void)didReceiveNotificationRequest:(UNNotificationRequest *)request withContentHandler:(void (^)(UNNotificationContent * _Nonnull))contentHandler {
  /*
    ...
    */
    ...
    [OneSignalCore didReceiveNotificationExtensionRequest:self.receivedRequest
...
- (void)serviceExtensionTimeWillExpire {
    ...
    [OneSignalCore serviceExtensionTimeWillExpireRequest:self.receivedRequest withMutableNotificationContent:self.bestAttemptContent];
